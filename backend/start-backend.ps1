...
if (-not (Test-Path $venvPython)) {
  Write-Host "Virtual environment Python was not created successfully." -ForegroundColor Red
  exit 1
}
...
& $venvPython -m uvicorn app.api.main:app --reload --host 0.0.0.0 --port 8000
